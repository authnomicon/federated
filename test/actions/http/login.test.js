...
describe('actions/http/login', function() {
  ...
  describe('handler', function() {
    ...
    it('should next with error when federated identifier fails to be associated with account', function(done) {
      var idStore = new Object();
      idStore.find = sinon.stub().yieldsAsync(null);
      idStore.add = sinon.stub().yieldsAsync(new Error('something went wrong'));
      var directory = new Object();
      directory.create = sinon.stub().yieldsAsync(null, {
        id: '703887',
        displayName: 'Jane Doe'
      ...
      chai.express.use(handler)
        ...
        .next(function(err, req, res) {
          ...
          expect(idStore.find).to.have.been.called;
          expect(idStore.add).to.have.been.called;
          expect(directory.create).to.have.been.called;
          expect(directory.read).to.not.have.been.called;
          expect(req.login).to.not.have.been.called;
        ...
        .listen();
    }); // should next with error when federated identifier fails to be associated with account
    
    it('should next with error when session initiation fails after provisioning', function(done) {
      var idStore = new Object();
      idStore.find = sinon.stub().yieldsAsync(null);
      idStore.add = sinon.stub().yieldsAsync(null);
      var directory = new Object();
      ...
      chai.express.use(handler)
        ...
        .listen();
    }); // should next with error when session initiation fails after provisioning
    
    it('should next with error when account fails to be found in directory', function(done) {
      var idStore = new Object();
      idStore.find = sinon.stub().yieldsAsync(null, {
        id: '703887'
      });
      ...
      var directory = new Object();
      directory.create = sinon.spy();
      directory.read = sinon.stub().yieldsAsync(new Error('something went wrong'));
      ...
      chai.express.use(handler)
        ...
        .next(function(err, req, res) {
          ...
          expect(idStore.add).to.not.have.been.called;
          expect(directory.create).to.not.have.been.called;
          expect(directory.read).to.have.been.called;
          expect(req.login).to.not.have.been.called;
          
          done();
        })
        .listen();
    }); // should next with error when account fails to be found in directory
    
    it('should next with error when session initiation fails on subsequent login', function(done) {
      var idStore = new Object();
      idStore.find = sinon.stub().yieldsAsync(null, {
        id: '703887'
      });
      ...
      chai.express.use(handler)
        ...
        .listen();
    }); // should next with error when session initiation fails on subsequent login
