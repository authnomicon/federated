...
/**
 * Create OAuth 2.0 redirection service.
 *
 * Returns an HTTP service that implements the OAuth 2.0 [redirection endpoint][1].
 *
 ...
 * authorization response will be used as a form of delegated user
 * authentication.
 *
